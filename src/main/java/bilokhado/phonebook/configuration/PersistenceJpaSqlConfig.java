...
public class PersistenceJpaSqlConfig extends JpaBaseConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory(EntityManagerFactoryBuilder factoryBuilder) {
		...
		LocalContainerEntityManagerFactoryBean emf = factoryBuilder.dataSource(dataSource).packages(getPackagesToScan())
				.persistenceUnit("SQL").properties(vendorProperties).jta(isJta()).build();
		return emf;
	}
